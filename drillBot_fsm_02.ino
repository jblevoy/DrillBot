...
//########################################################################################### SWITCH ###########################################################################################
    switch (state) {
        ...
        case RESET_part_1:                                                                                                                  // state 5
            if((digitalRead(12) == HIGH) && (micros() - stepper_timer_16 > hold_step) && (step_half_16 == 0)) {                             // drill head is already against limit switch, go down
        ...
        case RESET_part_2:                                                                  // state 6
            ...
            digitalWrite(8, HIGH);                                                          // feed dir to hopper position
